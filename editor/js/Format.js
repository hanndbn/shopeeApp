...
Format.prototype.refresh = function() {
  ...
  if (graph.isSelectionEmpty()) {
    ...
    if (this.getSelectionState().style.type === "CARD") {
      ...
      this.panels.push(new CardFormatPanel(this, ui, cardPanel));
...
CardFormatPanel = function(format, editorUi, container) {
  this.format = format;
  this.editorUi = editorUi;
  this.container = container;
  this.init();
...
CardFormatPanel.prototype.init = function() {
...
CardFormatPanel.prototype.destroy = function() {
};
...
CustomDiagramFormatPanel.prototype.init = function() {
  ...
  <div class="format-image-wrapper">
    <div class="row no-gutters tab-header-wrapper">
        <div class="col-6 tab-header-content">Inspector</div>
        <div class="col-6 tab-header-content">Layer</div>
    </div>
    <hr/>
    <div class="format-link-wrapper row no-gutters">
