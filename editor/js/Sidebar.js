...
Sidebar.prototype.addGeneralPalette = function(expand) {
  ...
  var fns2 = [
    ...
    // this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;rotation=-90;', 60, 80, '', 'Triangle top', null, null, 'triangle logic inverter buffer'),
    // this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;;', 60, 80, '', 'Triangle right', null, null, 'triangle logic inverter buffer'),
    // this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;rotation=90;', 60, 80, '', 'Triangle bottom', null, null, 'triangle logic inverter buffer'),
    // this.createVertexTemplateEntry('triangle;whiteSpace=wrap;html=1;rotation=-180;', 60, 80, '', 'Triangle left', null, null, 'triangle logic inverter buffer'),
