          ...
          <div className="d-flex justify-content-between">
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/1_24/E7yzRU.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/1_24/E7yzRU.png 1x, https://media3.scdn.vn/img3/2019/1_24/E7yzRU.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Flash Sale</div>
            </div>
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/4_23/rvrogh.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/4_23/rvrogh.png 1x, https://media3.scdn.vn/img3/2019/4_23/rvrogh.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Đồ điện tử</div>
            </div>
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/4_16/lVyewz.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/4_16/lVyewz.png 1x, https://media3.scdn.vn/img3/2019/4_16/lVyewz.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Giao Hàng Nhanh</div>
            </div>
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/1_24/WIQJlo.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/1_24/WIQJlo.png 1x, https://media3.scdn.vn/img3/2019/1_24/WIQJlo.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Vé máy bay</div>
            </div>
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/4_22/tvGYY6.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/4_22/tvGYY6.png 1x, https://media3.scdn.vn/img3/2019/4_22/tvGYY6.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Free Ship</div>
            </div>
            <div className="hot-line-wrapper">
              <div className="catalogue-icon">
                <img
                  src="//media3.scdn.vn/img3/2019/1_24/yjkXwt.png"
                  className="w-100"
                  srcSet="https://media3.scdn.vn/img3/2019/1_24/yjkXwt.png 1x, https://media3.scdn.vn/img3/2019/1_24/yjkXwt.png 2x"
                  alt=""
                />
              </div>
              <div className="hot-line-value">Thẻ điện thoại</div>
            </div>
          </div>
        </div>
