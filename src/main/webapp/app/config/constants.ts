...
export const SERVER_HOSTING_URL = 'https://silverbullet-sandbox.firebaseapp.com';
...
export const GENERATE_APP_API = SERVER_API_URL + '/api/generateCombinedApp';
