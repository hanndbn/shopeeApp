...
export const GET_CAROUSEL_DATA_URL = '/wp-json/acf/v3/carousel';
export const GET_CATEGORY_DATA_URL = '/wp-json/wp/v2/categories';
export const GET_PROJECTS_DATA_URL = '/wp-json/wp/v2/projects';
